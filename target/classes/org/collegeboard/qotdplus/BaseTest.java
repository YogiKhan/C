...
public class BaseTest {
	...
	public void setup() {
		...
		MintLogger.log(Level.INFO, "Environment: " + platform + " App : " + app
		...
		try {
			if (platform.equals(TestProperties.ANDROID)) {
				...
				MintLogger.log(Level.INFO, "Loading IOS  Desired Capabilities");
				DesiredCapabilities capabilities = new DesiredCapabilities();
		...
		MintLogger.log(Level.INFO, "End of Desired Capabilities");
	...
	private void loadProperties() {
		...
		try {
			MintLogger.log(Level.INFO, "Loading Properties for " + platform + ", " + appName);
			...
			MintLogger.log(Level.INFO, "Exception loading " + platform
					+ " properties file");
			e.printStackTrace();
		}
	...
	public void updateEnvironment() throws Exception {
		...
		if (platform.equals(TestProperties.ANDROID)) {
			MintLogger.log(Level.INFO, "Switching envionrment for " + platform
					+ " to " + env);
	...
	public void findElelemntByIndexAndClick(String classType, int index) {
		...
		*/
		MintLogger.log(Level.INFO,"findElelemntByIndexAndSendKeys to click floating icon");
